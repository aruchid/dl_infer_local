...
namespace display_process
{
    ...
    static const st_display_type_info DISPLAY_TYPE_INFO[] = {
        {DISPLAY_TYPE_DETECTION,     "display_process_det"},
        {DISPLAY_TYPE_SEGMENTATION,  "display_process_seg"},
        {DISPLAY_TYPE_CLASSIFICATION,"display_process_cls"},
        {DISPLAY_TYPE_OCR,          "display_process_ocr"}
    };
